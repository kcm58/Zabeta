...
(function ($) {
  ...
  var patterns = [/%ss/, /%mm/, /%hh/, /%dd/, /%s/, /%m/, /%h/, /%d/, /%SECONDS/, /%MINUTES/, /%HOURS/, /%DAYS/];
  ...
  function humanTime(seconds) {
    ...
    if (seconds <= 10) {
      ...
      text = 'about ' + Math.floor(minutes / 60) + ' hours ago';
      ...
      text = Math.floor(minutes / 43200) + ' months ago';
    } else if (minutes < 1051199) {
      text = 'about 1 year ago';
    } else {
    ...
    init: function (options) {
      ...
      return this.each(function () {
        ...
        var $this = $(this),
          //jQuery Object
          self = $this,
          //self can be passed to anonymous functions
        ...
        if (!data) {
          ...
          if (settings.tick > 0) {
            setupData.timer = setInterval(function () {
